/**
 * This is a Semaphore class. It works as a counter. It assures the value to be either bigger than zero, if smaller then zero, then it sets it to zero. It contains P and V methods.
 *
